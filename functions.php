<?php
/**
 * Sumun functions and definitions
 *
...
function sumun_setup() {
	...
	register_nav_menus(
		array(
			'primary' => esc_html__( 'Primary', 'projectbox' ),
		)
	);
...
add_action( 'after_setup_theme', 'sumun_setup' );
 ...
 */
function sumun_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'sumun_content_width', 640 );
}
add_action( 'after_setup_theme', 'sumun_content_width', 0 );
